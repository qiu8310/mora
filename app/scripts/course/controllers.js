...
var D = {
  ...
  charges: [
    [{n: 'a', day: 10, task: '10天完成课程所有关卡，闯关平均分在95分以上，集齐500赞', prize: '不仅全额返还钻石，更另外赠送200钻'},
      {n: 'b', day: 20, task: '20天完成课程所有关卡，闯关平均分在90分以上，集齐500赞', prize: '全额返还钻石'},
      {n: 'c', day: 20, task: '20天完成课程所有关卡，闯关平均分在85分以上，集齐500赞', prize: '返还课程价值的50%钻石'},
      {n: 'd', day: 20, task: '20天完成课程所有关卡，闯关平均分在80分以上，集齐500赞', prize: '返还课程价值的20%钻石'}],

    [{n: 'a', day: 15, task: '15天完成所有关卡，闯关平均分在95分以上，集齐500赞', prize: '不仅全额返还钻石，更另外赠送200钻'},
      {n: 'b', day: 30, task: '30天完成所有关卡，闯关平均分在90分以上，集齐500赞', prize: '全额返还钻石'},
      {n: 'c', day: 30, task: '30天完成所有关卡，闯关平均分在85分以上，集齐500赞', prize: '返还课程价值的50%钻石'},
      {n: 'd', day: 30, task: '30天完成所有关卡，闯关平均分在80分以上，集齐500赞', prize: '返还课程价值的20%钻石'}]
  ],
  courses: [
    {id: '', title: '赖世雄美语入门',
